...
jQuery(document).ready(function () {
    ...
    $('#my_multi_select3').multiSelect({
        selectableHeader: "<input type='text' class='form-control search-input' autocomplete='off' placeholder='جست و جو...'>",
        selectionHeader: "<input type='text' class='form-control search-input' autocomplete='off' placeholder='جست و جو...'>",
...
$('input#alloptions').maxlength({
    ...
    preText: 'شما ',
    postText: ' کاراکتر را تایپ کردید.',
    validate: true
});
