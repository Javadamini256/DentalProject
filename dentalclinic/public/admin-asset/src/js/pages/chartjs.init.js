...
!function($) {
    ...
    ChartJs.prototype.init = function() {
        //creating lineChart
        var lineChart = {
            labels: ["ژانویه", "فوریه", "مارس", "آوریل", "مه", "ژوئن", "جولای", "آگوست", "سپتامبر"],
            datasets: [
                {
                    label: "آنالیز فروش",
                    fill: false,
        ...
        //barchart
        var barChart = {
            labels: ["ژانویه", "فوریه", "مارس", "آوریل", "مه", "ژوئن", "جولای"],
            datasets: [
                {
                    label: "آنالیز فروش",
        ...
        //radar chart
        var radarChart = {
            labels: ["غذا", "نوشیدن", "خواب", "طراحی", "کد نویسی", "دوچرخه سواری", "پیاده روی"],
            datasets: [
                {
                    label: "دسکتاپ",
